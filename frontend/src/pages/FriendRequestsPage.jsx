...
export default function FriendRequestsPage() {
    ...
    return <div className="search-page-shell"><div className="search-page-card search-panel">
        <div className="recommended-header"><h2>Friend requests</h2><p>Accept a request to start chatting.</p></div>
        ...
        <div className="search-results">{requests.map((request) => <div className="search-result" key={request.id}>
            ...
            <button type="button" className="primary-button compact-action" onClick={() => respond(request, userService.acceptFriendRequest)}><Check size={15} /> Accept</button>
